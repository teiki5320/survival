...
final List<StoryCard> _fill10 = [
  _filler('F10_bain',
      ...
      oneshot: true),
  _filler('F10_arme',
      "Dans un casier scellé : un fusil de chasse, trois cartouches. Le prendre change ce que tu es.",
      _c("La prendre", fx: {Stat.moral: -4}, flags: ['aArme'], result: "Le métal te rassure et te dégoûte. Tu sauras te défendre, à la halte 31."),
      _c("La laisser", fx: {Stat.moral: 6}, result: "Si tu dois survivre, ce ne sera pas comme ça."),
      oneshot: true),
  _filler('F10_fruits',
