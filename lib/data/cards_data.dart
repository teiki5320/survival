...
List<StoryCard> _gare3(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Couper les feux, passer en fantôme",
            ...
            result: "Tu éteins tout et tu pousses doucement dans la brume, le cœur au bord des lèvres. Ils ne te verront pas — et au pas, tu peux rafler quelques conserves dans les wagons éventrés au passage. Mais rouler si lentement fait fondre le bois. Dans le silence, tu trouves un carnet abandonné et un crayon."),
        right: _c("Accélérer pour les semer",
            fx: {Stat.moral: 6, Stat.bois: -10},
            flags: ['asset_notebook'],
            result: "Tu ouvres les gaz. Un cri, des pas qui courent, une pierre contre la tôle — puis le brouillard les avale. Le soulagement te grise, mais le foyer a tout bu dans l'accélération. Sur la banquette, un carnet oublié par un ancien passager."),
      ),
      StoryCard(
        id: 'G3b',
        kind: CardKind.gare,
...
List<StoryCard> _gare7(Set<String> f) => [
      StoryCard(
        ...
        right: _c("Garder le cap, ne pas t'arrêter",
            fx: {Stat.bois: 8, Stat.moral: -5}, result: "Tu serres les dents et tu avances sans gaspiller un arrêt : la loco garde son élan, le bois dure. Le nord d'abord. Les souvenirs, après — et le sourire de ta sœur retombe."),
      ),
...
List<StoryCard> _gare10(Set<String> f) => [
      StoryCard(
        ...
        left: _c("S'accorder un vrai repos",
            ...
            result: "Quelques jours de chaleur et de rires. Vous reprenez des forces et de l'âme — mais la loco a refroidi, et il faudra brûler gros pour la relancer dans le froid qui s'installe. Avant de partir, vous démontez de quoi monter une tour hydroponique, une baignoire, un coin douche et deux lanternes dans le cellier. Puis le nord rappelle."),
