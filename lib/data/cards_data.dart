...
List<StoryCard> _gare3(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Couper les feux, passer en fantôme",
            ...
            flags: ['asset_notebook', 'asset_atelier'],
            result: "Tu éteins tout et tu pousses doucement dans la brume, le cœur au bord des lèvres. Ils ne te verront pas — et au pas, tu peux rafler quelques conserves dans les wagons éventrés au passage. Mais rouler si lentement fait fondre le bois. Dans le silence, tu trouves un carnet abandonné et un crayon. Le calme retrouvé, tu en profites pour ranger l'atelier encombré : un vrai coin de travail, enfin."),
        right: _c("Accélérer pour les semer",
            fx: {Stat.moral: 6, Stat.bois: -10},
            flags: ['asset_notebook', 'asset_atelier'],
            result: "Tu ouvres les gaz. Un cri, des pas qui courent, une pierre contre la tôle — puis le brouillard les avale. Le soulagement te grise, mais le foyer a tout bu dans l'accélération. Sur la banquette, un carnet oublié par un ancien passager. Une fois la peur retombée, tu ranges l'atelier en bazar : un vrai coin de travail, enfin."),
      ),
      StoryCard(
        id: 'G3b',
        kind: CardKind.gare,
...
List<StoryCard> _gare4(Set<String> f) => [
      StoryCard(
        ...
        right: _c("Rester méfiante",
            fx: {Stat.faim: 9, Stat.moral: -5}, flags: ['asset_filter'],
            result: "Des milliers d'enfants ont écrit ça. Tu n'oses pas y croire. Pas encore. À défaut d'espoir, tu fouilles le village de fond en comble et en ramènes des vivres et un filtre à eau."),
      ),
...
List<StoryCard> _gare6(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Troquer vite et partir",
            fx: {Stat.faim: 12, Stat.soif: 8, Stat.moral: -6}, flags: ['asset_wagon2', 'asset_shower'],
            result: "Tu obtiens des vivres mais tu sens leurs regards. Tu repars avant la nuit, elle serrée contre toi — en rattachant au convoi un wagon-cellier abandonné sur une voie de garage. Dedans, un vieux coin douche encore en état : de quoi se laver, enfin."),
        right: _c("Ne pas t'attarder une seconde",
            fx: {Stat.moral: 6, Stat.faim: -5}, flags: ['asset_wagon2', 'asset_shower'],
            result: "Tu refuses tout contact. Le ventre vide, mais ta sœur en sécurité. En partant, tu accroches un wagon-cellier laissé là : il abrite un coin douche de fortune, que tu remets vite en service."),
      ),
...
List<StoryCard> _gare7(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Lui raconter ce souvenir",
            fx: {Stat.moral: 16, Stat.bois: -5}, flags: ['asset_commode'], result: "Vous riez ensemble dans le wagon arrêté. Un moment volé, qui coûte un peu de route, mais qui vous répare. Dans le vieux kiosque, vous dénichez une commode en bois que vous ramenez : un meuble pour ranger vos affaires."),
        right: _c("Garder le cap, ne pas t'arrêter",
            fx: {Stat.bois: 8, Stat.moral: -5}, flags: ['asset_commode'], result: "Tu serres les dents et tu avances sans gaspiller un arrêt : la loco garde son élan, le bois dure. Le nord d'abord. Les souvenirs, après — et le sourire de ta sœur retombe. Au passage rapide, tu rafles une vieille commode laissée sur le quai."),
      ),
...
List<StoryCard> _gare9(Set<String> f) => [
      StoryCard(
        ...
        left: _c("La veiller toute la nuit",
            fx: {Stat.faim: -10, Stat.moral: 12}, flags: ['soeurProtegee', 'asset_firstaid', 'asset_lantern'], result: "Tu ne dors pas, tu éponges son front jusqu'à l'aube à la lueur de deux lanternes dénichées dans le cellier. Dans un coffre, une trousse de secours qui te sauve la nuit. La fièvre cède. Elle vivra."),
        right: _c("Braver la tempête pour des remèdes",
            fx: {Stat.soif: -12, Stat.moral: 8}, flags: ['soeurProtegee', 'asset_firstaid', 'asset_lantern'], result: "Tu sors dans le blizzard, tu reviens gelée avec une trousse de secours et des lanternes pillées dans une cabane. Tu accroches les lanternes dans le cellier et tu la soignes. Ça suffit. De justesse."),
      ),
