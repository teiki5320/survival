...
final List<StoryCard> _fill5 = [
  ...
  _filler('F5_citerne_aveugle',
      ...
      _c("Ne pas boire l'inconnu", fx: {Stat.moral: 3}, result: "Tu refermes la vanne. Une citerne sans nom dans un monde mort, ça ne se boit pas sur la foi. Tu repars la gorge sèche, mais entière."),
