...
List<StoryCard> _gare10(Set<String> f) => [
      StoryCard(
        ...
        left: _c("S'accorder un vrai repos",
            ...
            flags: ['asset_hydro', 'asset_bath', 'asset_shower'],
            result: "Quelques jours de chaleur et de rires. Vous reprenez des forces et de l'âme. Avant de partir, vous démontez de quoi monter une tour hydroponique, une baignoire et un coin douche dans le cellier. Puis le nord rappelle."),
        right: _c("Faire le plein et repartir vite",
            fx: {Stat.faim: 12, Stat.soif: 10, Stat.bois: 12, Stat.moral: -4},
            flags: ['asset_hydro', 'asset_bath', 'asset_shower'],
            result: "« Papa et maman attendent. » Elle comprend. Vous emportez des plants, le matériel hydroponique et de quoi installer un bain et une douche dans le cellier, et repartez le ventre plein, le cœur lourd."),
      ),
