...
List<StoryCard> _gare4(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Y croire, foncer au nord",
            ...
            flags: ['indiceSoeur', 'asset_filter', 'asset_fauteuil'],
            result: "Tu graves sa réponse à côté et tu pousses la loco. Au passage, tu récupères un filtre à eau et un vieux fauteuil club dans les ruines du village — de l'eau potable et un coin lecture, enfin. Si c'est elle, elle ne t'attendra pas en vain."),
        right: _c("Rester méfiante",
            fx: {Stat.faim: 9, Stat.moral: -5}, flags: ['asset_filter', 'asset_fauteuil'],
            result: "Des milliers d'enfants ont écrit ça. Tu n'oses pas y croire. Pas encore. À défaut d'espoir, tu fouilles le village de fond en comble et en ramènes des vivres, un filtre à eau et un fauteuil rembourré pour le salon."),
      ),
...
List<StoryCard> _gare8(Set<String> f) => [
      StoryCard(
        ...
        left: _c("Lui donner le tien",
            fx: {Stat.moral: 14, Stat.soif: -6}, flags: ['soeurProtegee', 'asset_stove'], result: "Tu grelottes à sa place. Elle s'endort contre toi, au chaud. Tu ne regrettes rien. À l'entrée de la zone froide, tu as installé un vrai poêle dans l'atelier."),
        right: _c("Pousser le feu à fond",
            fx: {Stat.bois: -16, Stat.moral: 6}, flags: ['asset_stove'], result: "Tu sacrifies ta réserve de bois pour la réchauffer. Le wagon est un four, pour l'instant. Tu finis par installer un vrai poêle dans l'atelier."),
      ),
...
final List<StoryCard> _fill8 = [
  ...
  // CHOIX DÉBLOQUÉ PAR UN OBJET : le filtre à eau (asset_filter, trouvé gare 4)
