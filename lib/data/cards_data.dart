...
List<StoryCard> _gare2(Set<String> f) => [
      ...
      StoryCard(
        ...
        left: _c("Déchiffrer le manuel, page à page",
            ...
            flags: ['asset_lamp', 'asset_filter', 'asset_salon'],
            result: "Des heures penchée sur les schémas, l'estomac vide. Mais le feu reprend, franc et vif. Tu sauras faire, maintenant. Tu récupères au dépôt une lampe, une petite table et un vieux filtre à eau de cheminots — et avec les outils de l'atelier du dépôt, tu remets le wagon de vie en état : vitres calfeutrées, sol récuré. Un vrai foyer, enfin."),
        right: _c("Y aller à l'instinct",
            fx: {Stat.bois: 6, Stat.moral: -3},
            flags: ['asset_lamp', 'asset_filter', 'asset_salon'],
            result: "Tu charges au jugé. Le feu crachote, capricieux. Tu apprendras dans la fumée et les jurons. Tu emportes quand même une lampe, une table et un filtre à eau dégoté dans un local du dépôt — et tu profites de la halte pour récurer le wagon de vie de fond en comble. C'est chez toi, maintenant."),
      ),
...
final List<StoryCard> _fill3 = [
  ...
  _filler('F3_lampe_brume',
      "Dans la brume, une lampe pendue à un piquet éclaire des caisses posées EN TRAVERS de la voie. Personne en vue. C'est un appât de pillards — mais les caisses, elles, sont bien réelles.",
      _c("Rafler les caisses au passage", fx: {Stat.faim: 9, Stat.moral: -6}, result: "Tu ralentis à peine, tu happes deux caisses au vol et tu fonces. Des cris jaillissent de la brume, trop tard. Des conserves plein les bras — et le cœur qui cogne encore des heures après : c'était À ÇA près."),
      _c("Écraser l'appât sans ralentir", fx: {Stat.bois: -7, Stat.moral: 4}, result: "Tu pousses la vapeur et tu pulvérises les caisses sans laisser au piège le temps de se refermer. Le butin éclate sous les roues — tant pis. On ne marchande pas sa peau contre des boîtes."),
...
final List<StoryCard> _fill6 = [
  ...
  _filler('F6_poupee',
      ...
      requires: (f) => f.contains('aLaSoeur'), art: CardArt.sister),
  _filler('F6_tableau_disparus',
      "À l'entrée du camp, un grand panneau croule sous les mots épinglés : des noms, des visages dessinés, des « SI TU LIS ÇA ». Le tableau des disparus. Tes parents l'ont peut-être lu. Ou pas encore.",
      _c("Épingler un mot pour tes parents", fx: {Stat.moral: 8, Stat.faim: -5}, result: "Tu passes l'heure du repas à écrire, raturer, réécrire. « On va au nord. On vous cherche. » Tu l'épingles bien en vue. C'est peu — mais quelque part, ton mot les attend peut-être."),
      _c("Lire chaque mot, chercher leurs noms", fx: {Stat.faim: 6, Stat.moral: -6}, result: "Tu épluches le tableau nom par nom en grignotant les rations du camp. Rien d'eux. Des centaines d'histoires brisées, et pas la tienne — tu repars nourrie et la gorge serrée."),
  ...
  // --- Renfort du camp Yasuragi (+4) : le décor social du camp exploité. ---
  _filler('F6_ecrivain_public',
      "Sous une bâche du camp, un vieil instituteur écrit les lettres des réfugiés qui ne savent plus tenir un crayon. Il propose de consigner TON histoire — « pour que quelqu'un la garde, au cas où ».",
      _c("Lui dicter ton histoire", fx: {Stat.moral: 9, Stat.faim: -5}, result: "Tu racontes tout : Kogarashi, la fuite, le nord. Il écrit sans un mot, plie la feuille dans une boîte en fer pleine de vies. « Si quelqu'un te cherche, il saura. » Tu repars plus légère d'un poids que tu ne savais pas porter."),
      _c("Garder ton histoire pour toi", fx: {Stat.faim: 5, Stat.moral: -4}, result: "Raconter, c'est admettre que tu pourrais ne pas arriver au bout. Tu déclines poliment et tu files à la distribution de vivres. L'estomac plein — et l'histoire toujours en vrac, en travers de la gorge."),
      oneshot: true, art: CardArt.memory),
  _filler('F6_reserve_commune',
      "Le camp met les vivres en commun : chacun verse au pot ce qu'il peut, chacun mange à sa faim ce soir-là. Ta réserve est maigre — mais la leur nourrit des enfants.",
      _c("Verser ta part au pot commun", fx: {Stat.moral: 10, Stat.faim: -7}, result: "Tu poses tes conserves sur la table commune sous les mercis. Le repas du soir est un vrai repas de VILLAGE, bruyant et chaud. Tu repars la réserve plus légère — et le souvenir d'avoir mangé PARMI des gens."),
      _c("Manger au pot sans rien verser", fx: {Stat.faim: 10, Stat.moral: -7}, result: "Tu tends ta gamelle en cachant ton sac plein. Personne ne vérifie — la confiance est la règle ici. Tu manges bien, deux soirs de suite. Mais chaque cuillerée a un arrière-goût que tu connais trop bien."),
      oneshot: true, art: CardArt.food),
  _filler('F6_enfants_camp',
      "Une bande d'enfants du camp tourne autour de ta sœur, timide d'abord, puis : « Tu viens jouer ? » Elle te lance LE regard — celui qui supplie sans un mot.",
      _c("La laisser jouer jusqu'au soir", fx: {Stat.moral: 12, Stat.bois: -6}, result: "Elle court, crie, tombe et rit avec des enfants de son âge pour la première fois depuis la fuite. Tu retardes le départ jusqu'au crépuscule, la loco froide. Ce rire-là valait toutes les bûches du monde.",
          reaction: "Ta sœur revient échevelée, les joues rouges : « Ils m'ont appris un jeu ! Je te montrerai dans le train ! »"),
      _c("Écourter, repartir avant la nuit", fx: {Stat.bois: 6, Stat.moral: -6}, result: "Une demi-heure, pas plus, et tu la rappelles. Elle obéit sans discuter — c'est pire que si elle pleurait. La route de nuit est dangereuse, tu as raison. Avoir raison n'a jamais réchauffé personne.",
          reaction: "Ta sœur agite longtemps la main vers le camp qui rapetisse : « Tu crois qu'ils seront au refuge, eux aussi ? »"),
      oneshot: true, requires: (f) => f.contains('aLaSoeur'), art: CardArt.sister),
  _filler('F6_veillee_camp',
      "Le soir, le camp se rassemble autour du grand feu : chants, thé de pin, histoires du monde d'avant. On te fait signe d'approcher. Ta place au feu — contre une brassée de ton bois.",
      _c("Payer ta place, veiller avec eux", fx: {Stat.moral: 9, Stat.bois: -6}, result: "Tu jettes tes bûches dans leur feu et tu te fonds dans le cercle. Un vieil homme raconte la mer, qu'il a vue trois fois. Tu ris avec des inconnus. Ce soir, le monde n'est pas mort — il veille."),
      _c("Regarder de loin, garder ton bois", fx: {Stat.bois: 5, Stat.moral: -5}, result: "Tu restes à la lisière de la lumière, ton bois serré contre toi. Les chants te parviennent par bribes, comme d'une autre vie. Économe, prudente — et dehors, exactement comme le froid.")),
];
...
final List<StoryCard> _fill9 = [
  ...
  _filler('F9_soeur_doute',
      ...
      requires: (f) => f.contains('aLaSoeur'), art: CardArt.sister),
  _filler('F9_verglas_rampe',
      "Dans la rampe, les roues PATINENT : la voie n'est plus qu'un miroir de glace vive. La loco hurle sur place, à brûler du bois pour rien.",
      _c("Forcer à pleine vapeur", fx: {Stat.bois: -12, Stat.moral: 4}, result: "Tu laisses les roues mordre la glace mètre par mètre, dans un vacarme d'enfer. La rampe cède avant toi — mais le foyer a englouti une fortune pour trois cents mètres."),
      _c("Sabler la voie à la main", fx: {Stat.bois: 7, Stat.faim: -10, Stat.soif: -6}, result: "Tu descends avec un seau de cendres et tu sables les rails devant les roues, dix mètres par dix mètres, dans le blizzard. Des heures. Tu remontes vidée, gelée — mais la loco est passée sans forcer.")),
...
final List<StoryCard> _fill14 = [
  ...
  _filler('F14_derniere_nuit',
      ...
      oneshot: true, art: CardArt.refuge),
  // --- Renfort du beat final (+4) : plus de variété à l'arrivée. ---
  _filler('F14_visage_foule',
      "Dans la foule du refuge, une silhouette de dos : le manteau de maman, sa natte, sa façon de pencher la tête. Ton cœur s'arrête. Ce n'est peut-être pas elle. Ce n'est sûrement pas elle.",
      _c("Courir, la retourner, savoir", fx: {Stat.moral: 8, Stat.faim: -5}, result: "Tu fends la foule en renversant la moitié d'une file de rationnement. La femme se retourne : ce n'est pas elle. Elle te sourit avec une douceur infinie — « Tu cherches ta mère ? Moi mon fils. Courage. » Tu repars vidée, mais moins seule."),
      _c("Détourner les yeux, te protéger", fx: {Stat.faim: 5, Stat.moral: -7}, result: "Tu t'interdis d'espérer sur une silhouette. Tu files vers la distribution de vivres, les mains qui tremblent. Rationnelle, nourrie — et hantée par ce dos que tu n'as pas osé vérifier."),
      oneshot: true, art: CardArt.hope),
  _filler('F14_adieu_loco',
      "Au dépôt du refuge, on te demande de céder ta loco : son foyer chauffera les dortoirs. Elle t'a portée depuis Kogarashi. C'est un tas de tôle. C'est ta maison.",
      _c("La confier, dire merci", fx: {Stat.moral: 9, Stat.bois: -6}, result: "Tu vides la soute pour les dortoirs et tu poses la main sur son flanc tiède une dernière fois. « Merci, vieille peau. » Les mécanos te promettent d'en prendre soin. Une page se tourne dignement."),
      _c("Négocier pour la garder", fx: {Stat.bois: 7, Stat.moral: -5}, result: "Tu refuses net et tu marchandes un emplacement au dépôt. On te regarde de travers — la solidarité du refuge a ses codes. Mais renoncer à ton seul foyer roulant, tu ne peux pas. Pas encore."),
      oneshot: true, art: CardArt.fire),
  _filler('F14_soupe_chaude',
      "À l'accueil du refuge, on te tend un bol de soupe FUMANTE — la première chose chaude servie par d'autres mains depuis la fuite. Derrière toi, la file des affamés s'allonge.",
      _c("La savourer lentement", fx: {Stat.faim: 9, Stat.moral: 6, Stat.soif: -4}, result: "Tu bois à petites gorgées, les larmes aux yeux, sans te presser malgré la file. Quelqu'un a fait cette soupe POUR ceux qui arrivent. Ce goût-là, c'est celui du monde d'avant — et tu pleures un peu dedans."),
      _c("La céder au vieillard derrière toi", fx: {Stat.moral: 10, Stat.faim: -6}, result: "Il tient à peine debout. Tu lui glisses ton bol dans les mains sans un mot. Son regard te suit longtemps. Arriver au refuge, c'est aussi redevenir quelqu'un qui donne."),
      oneshot: true, art: CardArt.food),
  _filler('F14_musique_refuge',
      "Quelque part dans le refuge, quelqu'un joue de l'accordéon. Une vraie musique, vivante, imparfaite. Autour, des gens s'arrêtent. Certains dansent. Certains pleurent.",
      _c("T'arrêter et écouter", fx: {Stat.moral: 10, Stat.bois: -4}, result: "Tu poses tes sacs et tu écoutes jusqu'au bout, immobile dans le froid. Des inconnus chantonnent faux, ensemble. C'est ça qu'on est venus chercher si loin au nord : pas des murs — des vivants."),
      _c("Passer ton chemin, t'installer d'abord", fx: {Stat.bois: 5, Stat.moral: -4}, result: "La musique attendra : il faut un toit, un lit, une place avant la nuit. Tu t'éloignes des notes à regret, méthodique jusqu'au bout — la survie a pris des habitudes qui ne se déposent pas si vite."),
      oneshot: true, art: CardArt.memory),
];
...
final List<StoryCard> kStateCards = [
  _filler('ST_epuisee',
      ...
      _c("Couper les machines, sombrer un moment",
          fx: {Stat.bois: 6, Stat.moral: 5, Stat.faim: -5},
          result: "Tu laisses le train ralentir et tu t'effondres une heure, le repas sauté. Tu perds du terrain — mais tu repars d'aplomb, et le feu a moins brûlé."),
  ...
  _filler('ST_choye',
      ...
      _c("Savourer ce répit, simplement",
          fx: {Stat.moral: 9, Stat.bois: -3},
          result: "Tu fermes les yeux et tu profites, la loco au ralenti qui sirote son bois. Ces moments-là, c'est aussi pour ça qu'on tient."),
